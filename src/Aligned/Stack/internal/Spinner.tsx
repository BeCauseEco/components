...
export const Spinner = styled.div<Pick<TStack, "loading" | "colorLoading">>(p => ({
  ...
  aspectRatio: "1",
  borderRadius: "50%",
  border: `2px solid ${computeColor(p.colorLoading || [EColor.Transparent])}`,
  ...
  "@container (height > 32px)": {
    height: "50%",
    border: `3px solid ${computeColor(p.colorLoading || [EColor.Transparent])}`,
  },

  "@container (height > 40px)": {
    height: "50%",
    border: `4px solid ${computeColor(p.colorLoading || [EColor.Transparent])}`,
  },
}))
