        ...
        <Global
          styles={css`
            ...
            .component-chart .recharts-legend-wrapper div {
              ...
              font-size: ${StyleBodyXsmall.fontSize};
            ...
            .component-chart .font-mono {
              ...
              font-weight: ${StyleMonospace.fontWeight};
              font-style: ${StyleMonospace.fontStyle};
              font-variation-settings: ${StyleMonospace.fontVariationSettings};

              color: ${computeColor([Color.Neutral, 700])};
            }

            .component-chart .font-bold {
              font-weight: 600;
            }

            .component-chart svg text .fill-foreground {
              ...
              font-size: ${StyleBodyXLarge.fontSize};
              line-height: ${StyleBodyXLarge.lineHeight};
            }
